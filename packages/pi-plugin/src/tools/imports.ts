 ...
 * Supports TS, JS, TSX, Python, Rust, Go, Solidity, Java, C#, PHP, Kotlin, Scala.
 */
...
export function registerImportTools(pi: ExtensionAPI, ctx: PluginContext): void {
  pi.registerTool({
    ...
    label: "import",
    description:
      "Language-aware import management. Supports TS, JS, TSX, Python, Rust, Go, Solidity, Java, C#, PHP, Kotlin, Scala. Ops: `add`, `remove`, `organize`. Use aft_safety checkpoint/undo before broad cleanup.",
